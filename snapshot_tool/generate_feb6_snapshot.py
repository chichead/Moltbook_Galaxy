# -*- coding: utf-8 -*-
"""
Moltbook Galaxy Snapshot Generator (Feb 6th 00:00 KST)
Uses Feb 5th web coordinates as a master anchor for visual continuity.
"""
...
# Config
# -----------------------------
CUTOFF_TIME = "2026-02-06 00:00:00"
DATA_DIR = "data"
...
def main():
    ...
    # Load Master Anchor (Feb 5 Web Coordinates)
    if os.path.exists(WEB_COORD_PATH):
        ...
        print("  - [WARNING] Master anchor not found. Initializing from scratch.")
    ...
    # Save Plot
    plot_path = os.path.join(RESULTS_DIR, "galaxy_0206_0000.png")
